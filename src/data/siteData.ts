...
export const BRAND = {
  ...
  address: '新竹市東區民族路158-3號',
  parking: '遠見民族停車場、遠見華生停車場',
  phone: '03-532-0618',
  phoneClean: '035320618',
  mobile: '0965-813-618',
  mobileClean: '0965813618',
  email: '',
  hours: [
    { day: '週一至週五', time: '11:30 - 20:30' },
    { day: '週六', time: '09:30 - 17:30' },
    { day: '週日', time: '公休' },
  ],
  social: {
    line: '',
    messenger: 'https://m.me/100092420351549',
    facebook: 'https://www.facebook.com/profile.php?id=100092420351549',
    instagram: 'https://www.instagram.com/jst_coming',
  },
...
export const FAQ = [
  {
    category: '預約相關',
    items: [
      { q: '如何預約？', a: '可以透過 Facebook 私訊、電話或官網表單預約。建議提前 3-5 天預約，以確保有位。' },
